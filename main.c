...
void main()
{
    int lck, tch;
    char ec;
    accs = (Account *)calloc(3, sizeof(Account)); /* Dynamic Memory Allocation for if(accs != NULL) Structure*/
    {
        Acdata();
    }
    ...
    start:
        ...
        setfillstyle(8, 8);
        floodfill(15, 15, 15); // Graphics Code for Home Screen Layout
        settextstyle(3,0,4);   
        ...
        settextstyle(3, 0, 2);
        outtextxy(190, 180, "Please Choose an Option"); // Graphics Code for Transaction Options Screen
        outtextxy(220,220,"1 >> Deposit Cash");         
        ...
        switch (tch) // Choice mechanism for choosing Transaction
        {
            ...
            default:
                ...
                rectangle(10, 10, 630, 450);
                setfillstyle(8, 8);
                floodfill(15, 15, 15);  // Code for resolving if choice is invalid
                settextstyle(3,0,4); 
